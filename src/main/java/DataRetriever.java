...
public class DataRetriever {
    ...
    public Order saveOrder(Order orderToSave) {
        ...
        for (DishOrder dishOrder : dishOrderList) {
            ...
            for (DishIngredient dishIngredient : dishIngredients) {
                ...
                double requiredQuantityForOrder = dishOrder.getQuantity() * dishIngredient.getQuantity();
    ...
    private void attachIngredients(Connection conn, List<DishIngredient> ingredients)
        ...
        String attachSql = """
                    insert into dishingredient (id, id_ingredient, id_dish, required_quantity, unit)
                    values (?, ?, ?, ?, ?::unit)
                """;
        ...
        try {
            PreparedStatement preparedStatement = connection.prepareStatement(
                    """
                            ...
                            from ingredient join dishingredient di on di.id_ingredient = ingredient.id where id_dish = ?;
                            """);
